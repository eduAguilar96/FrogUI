...
local DIAGNOSTIC_PROP_FAMILIES = {
    ...
    paint = {
        ...
        tileHeight = true, phase = true, velocity = true, repeatAxis = true,
        ...
        x = true, y = true, scale = true, coreRatio = true,
    ...
    retained = {
        ...
        fps = true, phase = true, velocity = true, value = true,
        values = true, axis = true, scrollPosition = true,
        snapInterval = true, onScrollEnd = true, x = true, y = true,
        rotation = true, scale = true, opacity = true, tint = true,
